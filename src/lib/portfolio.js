...
export const POPULAR_ASSETS = [
  ...
  { id: 'jup', name: 'Jupiter', symbol: 'JUP', assetType: 'crypto', defaultPriceUSD: 0.196, defaultPricePHP: 12.01 },
  { id: 'pump', name: 'Pump.fun', symbol: 'PUMP', assetType: 'crypto', defaultPriceUSD: 0.00223, defaultPricePHP: 0.136 },
  { id: 'uni', name: 'Uniswap', symbol: 'UNI', assetType: 'crypto', defaultPriceUSD: 4.15, defaultPricePHP: 254.18 },
  { id: 'aave', name: 'Aave', symbol: 'AAVE', assetType: 'crypto', defaultPriceUSD: 92.12, defaultPricePHP: 5642.78 },
  { id: 'bp', name: 'Backpack Token', symbol: 'BP', assetType: 'crypto', defaultPriceUSD: 0.368, defaultPricePHP: 22.54 },
